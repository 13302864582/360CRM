...
public class GridItemDecoration extends RecyclerView.ItemDecoration{
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int top = child.getTop() - params.topMargin + (isNormalGrid?0:mHorizonSpan);
            final int bottom = child.getBottom() + params.bottomMargin - (isNormalGrid?0:mHorizonSpan);
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
    ...
    public static class Builder {
        ...
        /**
         * 是否正常网格，是绘制横竖满格，否，绘制类似我的模块中的短线
         * */
        public GridItemDecoration.Builder setNormalGrid(boolean NormalGrid){
            mNormalGrid = NormalGrid;
            return this;
        }

        public GridItemDecoration build() {
            return new GridItemDecoration(mHorizonSpan, mVerticalSpan, mColor,mShowLastLine,mNormalGrid);
        }
    }
}
